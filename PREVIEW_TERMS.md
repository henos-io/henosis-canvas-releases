...
You may not sell, sublicense, redistribute, publicly host, or provide the
Software as a service. You may not modify, reverse engineer, decompile, or
attempt to derive its source code, except to the extent that such a restriction
is prohibited by applicable law.

The Software may not be used in production or for safety-critical purposes.
