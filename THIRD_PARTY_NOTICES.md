...
The runtime includes Node.js, which is distributed under the Node.js licence
and includes software under additional compatible licences. A copy of the
Node.js licence is included in each platform archive under `node/LICENSE`.

The application also includes JavaScript packages such as Next.js, React,
Drizzle ORM, better-sqlite3, the Model Context Protocol SDK, and their
